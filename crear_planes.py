import os
os.makedirs('src/billing', exist_ok=True)

with open('src/billing/__init__.py', 'w') as f:
    f.write('')
...
with open('src/billing/planes.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Sistema de planes creado correctamente")