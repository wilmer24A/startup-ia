...
# Crea __init__.py
with open('src/security/__init__.py', 'w') as f:
    f.write('')
...
with open('src/security/detector_injection.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Detector de injection creado correctamente")